...
namespace FoodPlanner.Controllers
{
    public class LightFoodNutrientsController : Controller
    {
        ...
        public LightFoodNutrientsController(FoodPlannerContext context)
        {
            _context = context;
        }
        ...
        {
            var lightfoodmainIngrdient = await _context.MainIngredients.ToListAsync();
            ...
            return View(await _context.lightFoodNutrients.ToListAsync());
        }

        // GET: LightFoodNutrients/Details/5
        public async Task<IActionResult> Details(long? id)
        {
            var result = await _context.lightFoodNutrients.FirstOrDefaultAsync(x => x.Id == id);
            var lightfoodmainIngrdient = await _context.MainIngredients.ToListAsync();
            ViewData["lightfoodmainIngrdient"] = lightfoodmainIngrdient;
            var lightfood = await _context.LightFood.ToListAsync();
            ViewData["lightfood"] = lightfood;
            ...
            var lightFoodNutrient = await _context.lightFoodNutrients
        ...
        public async Task<IActionResult> Edit(long? id)
        {
            ...
            var lightFoodNutrient = await _context.lightFoodNutrients.FindAsync(id);
            if (lightFoodNutrient == null)
            {
                return NotFound();
            }
        ...
        {
            var lightFoodNutrient = await _context.lightFoodNutrients.FindAsync(id);
            _context.lightFoodNutrients.Remove(lightFoodNutrient);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.lightFoodNutrients.Any(e => e.Id == id);
        }
    }
}
