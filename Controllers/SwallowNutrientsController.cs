...
namespace FoodPlanner.Controllers
{
    public class SwallowNutrientsController : Controller
    {
        ...
        public SwallowNutrientsController(FoodPlannerContext context)
        {
            _context = context;
        }
        ...
        {
            var swallows = await _context.Swallows.ToListAsync();
            ViewData["swallows"] = swallows;
            var mainIngredients = await _context.MainIngredients.ToListAsync();
