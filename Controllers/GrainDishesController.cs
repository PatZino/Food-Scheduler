...
namespace FoodPlanner.Controllers
{
    public class GrainDishesController : Controller
    {
        ...
        public GrainDishesController(FoodPlannerContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.GrainDishes.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var grainDish = await _context.GrainDishes
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var grainDish = await _context.GrainDishes.FindAsync(id);
            if (grainDish == null)
            {
                return NotFound();
            }
        ...
        {
            var grainDish = await _context.GrainDishes.FindAsync(id);
            _context.GrainDishes.Remove(grainDish);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.GrainDishes.Any(e => e.Id == id);
        }
    }
}
